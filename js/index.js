...
let ripetizioni = 0;
let _refInterval;
let colors = ["bg-danger", "bg-primary", "bg-success", "bg-warning"];
let marche = ["Peugeot", "Ford", "Renault", "Fiat"];

window.onload = function()
{
    //region genera wrapper superiore
...
function showValue(div){
    ...
    document.getElementById("divRis").style.visibility = "visbile";
}
...
function genera(){
    ...
    else
    {
        ...
        document.getElementById(document.getElementById("divMarca").innerHTML).style.lineHeight = parseInt(document.getElementById(document.getElementById("divMarca").innerHTML).style.lineHeight) + parseInt(document.getElementById("divValue").innerHTML) + "px";
